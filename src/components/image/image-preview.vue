        ...
        <transition name="fade">
            <div class="ivu-image-preview-wrap" v-if="modelValue" :style="maskStyle">
                <div class="ivu-image-preview" v-bind="$attrs" @click.stop="handleClickMask">
                    ...
                    />
                    <div class="ivu-image-preview-operations">
                    ...
                    <Icon :class="leftClasses" type="ios-arrow-back" @click.stop="handleSwitch(false)" />
                    <Icon :class="rightClasses" type="ios-arrow-forward" @click.stop="handleSwitch(true)" />
